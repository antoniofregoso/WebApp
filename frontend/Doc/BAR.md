...
```json
     {
            "id": "monthly_inflation_bar_vertical",
            "type": "bar",
            "mode":"vertical",
            "title": {
...
```json
     {
            "id": "monthly_inflation_bar_horizontal",
            "type": "bar",
            "mode":"horizontal",
            "title": {
                "en": "Monthly Inflation in Argentina, 2002",
...
![Staked Bar](./images/staked_bar.png)

## Horizontal Stacked Bar

```json
{
            "id": "product_comparison_bar_horizontal",
            "type": "bar",
            "mode":"horizontal",
            "title": {
                "en": "Monthly Inflation in Argentina, 2002",
...
![Horizontal Staked Bar](./images/horizontal_staked_bar.png)